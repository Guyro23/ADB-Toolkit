...
## Check if the script is run as root user or not
# if [ $(id -u) -ne 0 ];
# then
...
## Help Message, Appears when you dont supply proper option to install
function help () {
    echo -e "To install ADB-Toolkit use :- \nsudo bash $0 install \e[92mor \e[0msudo bash $0 -i \e[92mor \e[0msudo bash $0 -install"
}
